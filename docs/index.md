...
!!! tip "Start here — end-to-end publication"
    ...
    **Latest release:** **[v0.2.5](releases/v0.2.5.md)** · **Roadmap (complete):** **[v0.2.5](roadmap/v0.2.5.md)** · **Tracking (closed):** **[v0.2.5 campaign](tracking/v0.2.5-campaign.md)** (also first item under **Publication & reports** in the sidebar) · prior **[v0.2.4](releases/v0.2.4.md)** · **[Publication workflow audit](audits/v0.2.4-publication-workflow-audit.md)** (evidence-driven gaps).
...
| **4. CI & drift** | [Verification](workflows/verification.md) — layers: `alwm validate` (one file), `validate-artifacts` (committed sweep), `just ci` (full bar) |
...
| **7. Where examples live** | [Examples index](examples/README.md) — `examples/` packs, campaign runs, compares |

Use the left sidebar **Publication & reports (v0.2.5)** for the same pages in narrative order.

## Milestones & releases

| | |
| --- | --- |
| **Latest release** | [v0.2.5](releases/v0.2.5.md) |
| **Next milestone** | Not yet defined (new work under repository root **`CHANGELOG.md`** → **`[Unreleased]`**) |
...
- **Workflows** — [Benchmarking](workflows/benchmarking.md), [reporting](workflows/reporting.md) (also under **Publication & reports** in the site nav), [local dev](workflows/local-dev.md), [smoke](workflows/smoke.md), [multi-agent parallel](workflows/multi-agent-parallel.md), **[Documentation site handbook](workflows/docs-site.md)** (MkDocs nav, `just docs-build`, CI).
...
- **Tracking** — [Campaign orchestration](tracking/campaign-orchestration.md), [v0.2.5 tracking (closed)](tracking/v0.2.5-campaign.md), [v0.2.4 tracking (closed)](tracking/v0.2.4-campaign.md).
