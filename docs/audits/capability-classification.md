...
| `MCPBrowserRunner` | **stub** | `NotImplementedError` in `browser/stubs.py` |
| `alwm benchmark run` (offline) | **complete** | `tests/test_benchmark.py`, fixtures under `fixtures/benchmarks/` |
