...
**campaign_id:** `campaign.examples.minimal_offline.v1` · **title:** Minimal offline campaign (single suite, deterministic)
...
| **Member runs** | **1** copied **of 1** campaign manifest row(s) · `membership_scope`: **`all_runs`** |
...
- **pack_identity_fingerprint:** `sha256:931379d1fa93f8acac0485198d40e201f874c020b92802229a5d8cd3616fcc38`
