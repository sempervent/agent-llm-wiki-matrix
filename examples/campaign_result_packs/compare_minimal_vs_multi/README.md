...
- **`pack-compare-report.md`** — human-readable summary (**Reader interpretation** first, then fingerprints, artifact paths, backend means, semantic instability, **browser evidence** subsection, FT-\* deltas, member runs, portability warnings).
